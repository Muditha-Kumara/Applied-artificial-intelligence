...
1. **Parameter Changed:** [Dropout Rate from 0.25 to 0.15]

**Dropout with 0.25**
![Dropout with 0.25](image-17.png "Dropout with 0.25")
**Dropout with 0.15**
![Dropout with 0.15](image-18.png "Dropout with 0.15")
   * **What happened:** Validation accuracy increased.
...
### Nikolai Podkorytov
"For me, the most valuable part of this assignment was creating a complete training pipeline and understanding how preprocessing, augmentation, and model architecture impact validation accuracy. I also gained practical skills in debugging training loops, fixing shape inconsistencies, and comparing workflow differences between TensorFlow/Keras and PyTorch. Working through these steps helped me better understand how small architectural or preprocessing decisions impact model stability and overall performance."
...
**Commit:** [ca4552600f25cc6e8df68064dd200b6d78ab9f3a](https://github.com/Muditha-Kumara/Applied-artificial-intelligence/commit/ca4552600f25cc6e8df68064dd200b6d78ab9f3a)
